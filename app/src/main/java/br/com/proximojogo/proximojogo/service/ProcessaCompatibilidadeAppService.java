...
public class ProcessaCompatibilidadeAppService extends JobService {
    ...
    public boolean onStartJob(JobParameters job) {
        Log.i(ProcessaCompatibilidadeAppService.class.getName().toString(), "Inicio verificação de Compatibilidade");
        new MantemCompatibilidadeBack().processaCompatibilidade();
        return false;

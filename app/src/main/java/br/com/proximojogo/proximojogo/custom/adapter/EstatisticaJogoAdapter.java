package br.com.proximojogo.proximojogo.custom.adapter;
...
public class EstatisticaJogoAdapter extends ArrayAdapter<EstatisticaDeJogos> implements View.OnClickListener {
    private ArrayList<EstatisticaDeJogos> dataSet;
    Context mContext;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        EstatisticaDeJogos dataModel = getItem(position);
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.row_estatistica_jogo, parent, false);
